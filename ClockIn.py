...
time.sleep(1)
#Click check in
checkin_b=pyautogui.locateCenterOnScreen('LocateIcons/checkin.png')
click(checkin_b)
time.sleep(1)
#Click ok
...
def send_emails(email_ad):
    body=f'Attached is a screenshot to confirm that you have been successfully clocked in. If this screenshot does not depict a success message for the current date ({current_date}), then you have not successfully been clocked in.'

    #Make a MIME object to define parts of the email
    msg=MIMEMultipart()
    msg['from']=email_ad
    msg['to']=email_ad
    msg['subject']=f'Confirmation of successful workday clock in on {current_date}.'
